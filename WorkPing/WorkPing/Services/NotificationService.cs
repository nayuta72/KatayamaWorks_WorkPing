...
public class NotificationService
{
    ...
    private const string AppId = "KikakuTools.WorkPing";
    ...
    public void Initialize()
    {
        try
        {
            // ステータス別アイコン PNG を生成する（%TEMP%\WorkPing\icons\ に保存）
    ...
    /// トースト通知を送信する。
    /// </summary>
    /// <param name="title">通知のタイトル（例：WorkPing）</param>
    ...
    ///
    /// 登録先：HKCU\SOFTWARE\Classes\AppUserModelId\KikakuTools.WorkPing
    ///   DisplayName : "WorkPing"
    ...
    private static void RegisterAumid()
    {
        ...
        key.SetValue("DisplayName", "WorkPing");
