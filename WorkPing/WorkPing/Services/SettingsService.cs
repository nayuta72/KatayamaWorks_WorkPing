...
/// 設定は %AppData%\Roaming\kikakutools\WorkPing\settings.json に保存される。
...
public class SettingsService
{
    ...
    {
        // %AppData%\Roaming\kikakutools\WorkPing\ を設定ファイルの保存先とする
        var appData = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData);
        _settingsDirectory = Path.Combine(appData, "kikakutools", "WorkPing");
