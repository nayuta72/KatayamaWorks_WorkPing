...
using WorkPin.Features.AttendanceLog.ViewModels;
using WorkPin.Features.AttendanceLogViewer.ViewModels;
...
public partial class App : Application
{
    ...
    private static readonly string TraceLogPath =
        Path.Combine(Path.GetTempPath(), "WorkPin_startup.log");
    private static readonly string CrashLogPath =
        Path.Combine(Path.GetTempPath(), "WorkPin_crash.log");
    ...
    /// <summary>起動トレースを %TEMP%\WorkPin_startup.log に追記する。</summary>
